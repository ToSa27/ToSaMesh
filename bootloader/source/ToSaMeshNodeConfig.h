...
#include "ToSaMeshNodeType.h"

#ifdef TOSA_MESH_NODETYPE_MASTER
#define TOSA_MESH_HARDWARE_RASPBERRYPI
#define TOSA_MESH_MASTER_ADDRESS			0x0001
#include <arpa/inet.h>
#include <dirent.h>
#include <fstream>
#include <iostream>
...
#ifdef TOSA_MESH_NODETYPE_BOOTLOADER
...
#ifdef TOSA_MESH_HARDWARE_RASPBERRYPI
...
#ifdef TOSA_MESH_HARDWARE_ATMEGA328
