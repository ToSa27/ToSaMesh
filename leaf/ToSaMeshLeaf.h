#ifndef __ToSaMeshLeafGP_h__
#define __ToSaMeshLeafGP_h__
...
#define TOSA_MESH_CONFIG_TYPE_IO_SIZE			3
...
#define TOSA_MESH_CONFIG_TYPE_NETWORK_SIZE		5
...
#define TOSA_MESH_CONFIG_TYPE_CONTROL_SIZE		5
...
#define TOSA_MESH_CONFIG_TYPE_PARAMETER_SIZE	2
...
#define TOSA_MESH_CONFIG_TYPE_TIMER_SIZE		7

class ToSaMeshLeaf : public ToSaMeshLeafBase {
	public:
		void setup();
		void loop();
	private:
